...
public class DlgCariPiutangKary extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgCariPiutangKary(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ppResepObat.setText("Aturan Pakai Kronis");
        ...
        ppResepObat1.setText("Aturan Pakai Karyawan ");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Piutang Obat, Alkes & BHP Medis Karyawan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
//                        nama);
                ...
                bayarpiutang1.setAlwaysOnTop(false);
                bayarpiutang1.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPiutangKary dialog = new DlgCariPiutangKary(new javax.swing.JFrame(), true);
