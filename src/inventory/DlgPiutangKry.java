...
public class DlgPiutangKry extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgPiutangKry(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgPiutang")) {
                    if (form.petugas.getTable().getSelectedRow() != -1) {
                        ...
                        kdpasien.setText("000000");
                        nmpasien.setText("Pasien Resep Bebas");

                        catatan.setText(form.petugas.getTable().getValueAt(form.petugas.getTable().getSelectedRow(), 0).toString() + "-" + form.petugas.getTable().getValueAt(form.petugas.getTable().getSelectedRow(), 1).toString());
                    }
                    kdptg.requestFocus();
                }
            }
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){                   
                    ...
                    catatan.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),0).toString() + "-" + pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),1).toString());
                }   
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Piutang Karyawan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        label16.setBounds(360, 10, 70, 23);

        label13.setText("Petugas :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label13);
        label13.setBounds(360, 40, 70, 23);

        kdpasien.setEditable(false);
        kdpasien.setText("00000");
        ...
        BtnPasien.setBounds(340, 40, 28, 23);
        ...
        label32.setBounds(360, 70, 70, 23);
...
private void BtnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGudangActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPiutangKry dialog = new DlgPiutangKry(new javax.swing.JFrame(), true);
    ...
    public void setPasien(String norm, String pasien) {
    ...
    private void autoNomor() {
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(piutang.nota_piutang,3),signed)),0) from piutang where piutang.tgl_piutang='" + Valid.SetTgl(TglJual.getSelectedItem() + "") + "' ",
                "HK" + TglJual.getSelectedItem().toString().substring(8, 10) + TglJual.getSelectedItem().toString().substring(3, 5) + TglJual.getSelectedItem().toString().substring(0, 2), 3, NoNota);
    }
